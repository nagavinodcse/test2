...
class Step1 extends Component{
    ...
    render() {
        return this.props.step1 ? <Animated animationIn="bounceInRight" animationOut="bounceOutLeft" isVisible={true}>
            ...
            <div className="mt-3">
                <TestTypes selectedOption={this.state.selectedOption} handleChange={this.props.handleChange}/>
                <div className="mt-3 d-flex">
                    {(this.props.wsh.length>0 || this.props.webcrawler !== '') ? <button type="button" onClick={this.props.submitTest} className="btn btn-primary ml-auto">Next &gt;&gt;</button> : null}
                </div>
            </div>
        </Animated> : '';
    }
        ...
        return this.props.step2 ?
            ...
            <div className="mt-3 d-flex">
                {(this.props.selectedOS.length > 0) ?
                    <button type="button" className="btn btn-primary ml-auto" onClick={this.props.submitOS}>Next &gt;&gt;</button> : null}
            </div>
        </Animated> : '';
    }
}
class Step3 extends Component{
    ...
    handlePath = (e) => {
        ...
        console.log(i);console.log(prop);
            ...
            this.props.selectedOS.map((os,i) =>
            {
                return (
                    <Form.Group key={`OS-${i}`}>
                        ...
                        <Form.Control id={`OS-${i}`} type="text" name={`OS[${i}]`} onChange={this.handlePath}/>
                    </Form.Group>
                )
            })
            : '';
        ...
        return (
            <div className="mt-3 container">
                <Card bg="dark" text="white">
                    ...
                    <Card.Body>
                        <Step1 step1={this.state.step1} handleChange={this.handleTestTypeChange} wsh={this.state.wsh} submitTest={this.submitTestType} webcrawler={this.state.webcrawler}/>
                        <Step2 step2={this.state.step2} selectedOS={this.state.selectedOS} handleParent={this.handleTestTypeChange} submitOS={this.submitOS}/>
                        <Step3 step3={this.state.step3} selectedOS={this.state.selectedOS} handleParent={this.handleTestTypeChange}/>
                    </Card.Body>
                </Card>
            </div>
        );
